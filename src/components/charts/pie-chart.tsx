                ...
                <Label
                  content={({ viewBox }) => {
                    if (viewBox && "cx" in viewBox && "cy" in viewBox) {
                      ...
                      if (factLabel) {
                        titleYOffset = isFullscreen ? -20 : -14;
                        valueYOffset = isFullscreen ? 14 : 10;
                        labelYOffset = isFullscreen ? 44 : 28;
                      } else {
                        titleYOffset = isFullscreen ? -8 : -6;
                        valueYOffset = isFullscreen ? 24 : 16;
                        labelYOffset = 0;
                      }
